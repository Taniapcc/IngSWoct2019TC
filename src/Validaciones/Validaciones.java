...
public class Validaciones extends PlainDocument {
    ...
    public void ValidarCaracteres(java.awt.event.KeyEvent evt){
        ...
        if((car<'a'|| car>'z')&&(car<'A'||car>'Z')//tecto de a a la z tanto minusculas como MYUSCULAS
            ...
            evt.consume();
            JOptionPane.showMessageDialog(null, "solo de admite carácteres","validar caracteres",JOptionPane.INFORMATION_MESSAGE);
        }
    }
    public void ValidarNumeros(java.awt.event.KeyEvent evt){
        ...
        if((num<'0'||num>'9')
            ...
            evt.consume();
            JOptionPane.showMessageDialog(null, "Solo se admite números","validar carácteres",JOptionPane.INFORMATION_MESSAGE);
